...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:5173', 
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Juntas Comunales',
    'DESCRIPTION': 'API para gestión de solicitudes de Juntas Comunales en Panamá',
    'VERSION': '1.0.0',
